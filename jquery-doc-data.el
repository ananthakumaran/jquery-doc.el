...
(puthash "deferred.pipe" (quote (("name" . "deferred.pipe") ("signatures" "deferred.pipe" (("doneFilter" "
            An optional function that is called when the Deferred is resolved.
	  " "true") ("failFilter" "
            An optional function that is called when the Deferred is rejected.
	  " "true"))) ("desc" (text . "   Utility method to filter and/or chain Deferreds.
...
(puthash "deferred.always" (quote (("name" . "deferred.always") ("signatures" "deferred.always" (("alwaysCallbacks" "
            A function, or array of functions, that is called when the Deferred is resolved or rejected.
	  " nil))) ("desc" (text . "   Add handlers to be called when the Deferred object is either resolved
   or rejected.
...
(puthash "promise" (quote (("name" . "promise") ("signatures" "promise" (("type" " The type of queue that needs to be observed. " "true") ("target" "Object onto which the promise methods have to be attached" "true"))) ("desc" (text . "   Return a Promise object to observe when all actions of a certain type
...
(puthash "removeProp" (quote (("name" . "removeProp") ("signatures" "removeProp" (("propertyName" "The name of the property to set." nil) ("value" "A value to set for the property." nil))) ("desc" (text . "   Remove a property for the set of matched elements.
...
(puthash "prop" (quote (("name" . "prop") ("signatures" "prop" (("propertyName" "The name of the property to get." nil))) ("desc" (text . "   Get the value of a property for the first element in the set of matched
   elements.
...
(puthash "prop" (quote (("name" . "prop") ("signatures" "prop" (("propertyName" "The name of the property to set." nil) ("value" "A value to set for the property." nil)) (("map" "A map of property-value pairs to set." nil)) (("propertyName" "The name of the property to set." nil) ("function(index, oldPropertyValue)" "A function returning the value to set. Receives the index position of the element in the set and the old property value as arguments. Within the function, the keyword " nil))) ("desc" (text . "   Set one or more properties for the set of matched elements.
...
(puthash "$.ajaxPrefilter" (quote (("name" . "$.ajaxPrefilter") ("signatures" "$.ajaxPrefilter" (("dataTypes" "An optional string containing one or more space-separated dataTypes" "true") ("handler(options, originalOptions, jqXHR)" "A handler to set default values for future Ajax requests." nil))) ("desc" (text . "   Handle custom Ajax options or modify existing options before each
...
(puthash "$.holdReady" (quote (("name" . "$.holdReady") ("signatures" "$.holdReady" (("hold" "Indicates whether the ready hold is being requested or released" nil))) ("desc" (text . "   Holds or releases the execution of jQueryʼs ready event.
...
(puthash "$.hasData" (quote (("name" . "$.hasData") ("signatures" "$.hasData" (("element" "A DOM element to be checked for data." nil))) ("desc" (text . "   Determine whether an element has any jQuery data associated with it.
...
(puthash "deferred.promise" (quote (("name" . "deferred.promise") ("signatures" "deferred.promise" (("target" "Object onto which the promise methods have to be attached" "true"))) ("desc" (text . "   Return a Deferredʼs Promise object.
...
(puthash "$.parseXML" (quote (("name" . "$.parseXML") ("signatures" "$.parseXML" (("data" "a well-formed XML string to be parsed" nil))) ("desc" (text . "   Parses a string into an XML document.
...
(puthash "$.when" (quote (("name" . "$.when") ("signatures" "$.when" (("deferreds" "One or more Deferred objects, or plain JavaScript objects." nil))) ("desc" (text . "   Provides a way to execute callback functions based on one or more
...
(puthash "deferred.resolveWith" (quote (("name" . "deferred.resolveWith") ("signatures" "deferred.resolveWith" (("context" "
              Context passed to the doneCallbacks as the " nil) ("args" "
              An optional array of arguments that are passed to the doneCallbacks.
	    " "true"))) ("desc" (text . "   Resolve a Deferred object and call any doneCallbacks with the given
   context and args.
...
(puthash "deferred.rejectWith" (quote (("name" . "deferred.rejectWith") ("signatures" "deferred.rejectWith" (("context" "
              Context passed to the failCallbacks as the " nil) ("args" "
              An optional array of arguments that are passed to the failCallbacks.
	    " "true"))) ("desc" (text . "   Reject a Deferred object and call any failCallbacks with the given
   context and args.
...
(puthash "deferred.fail" (quote (("name" . "deferred.fail") ("signatures" "deferred.fail" (("failCallbacks" "
	    ...
	    " "true"))) ("desc" (text . "   Add handlers to be called when the Deferred object is rejected.
...
(puthash "deferred.done" (quote (("name" . "deferred.done") ("signatures" "deferred.done" (("doneCallbacks" "
	    ...
	    " "true"))) ("desc" (text . "   Add handlers to be called when the Deferred object is resolved.
...
(puthash "deferred.then" (quote (("name" . "deferred.then") ("signatures" "deferred.then" (("doneCallbacks" "
	    ...
	    " nil))) ("desc" (text . "   Add handlers to be called when the Deferred object is resolved or
   rejected.
...
(puthash "deferred.reject" (quote (("name" . "deferred.reject") ("signatures" "deferred.reject" (("args" "
              Optional arguments that are passed to the failCallbacks.
	    " nil))) ("desc" (text . "   Reject a Deferred object and call any failCallbacks with the given
   args.
...
(puthash "deferred.resolve" (quote (("name" . "deferred.resolve") ("signatures" "deferred.resolve" (("args" "
              Optional arguments that are passed to the doneCallbacks.
	    " nil))) ("desc" (text . "   Resolve a Deferred object and call any doneCallbacks with the given
   args.
...
(puthash "fadeToggle" (quote (("name" . "fadeToggle") ("signatures" "fadeToggle" (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Display or hide the matched elements by animating their opacity.
...
(puthash "$.type" (quote (("name" . "$.type") ("signatures" "$.type" (("obj" "Object to get the internal JavaScript [[Class]] of." nil))) ("desc" (text . "   Determine the internal JavaScript [[Class]] of an object.
...
(puthash "$.isWindow" (quote (("name" . "$.isWindow") ("signatures" "$.isWindow" (("obj" "Object to test whether or not it is a window." nil))) ("desc" (text . "   Determine whether the argument is a window.
...
(puthash "toggle" (quote (("name" . "toggle") ("signatures" "toggle" (("handler(eventObject)" "A function to execute every even time the element is clicked." nil) ("handler(eventObject)" "A function to execute every odd time the element is clicked." nil) ("handler(eventObject)" "Additional handlers to cycle through after clicks." "true"))) ("desc" (text . "   Bind two or more handlers to the matched elements, to be executed on
   alternate clicks.
...
(puthash "undelegate" (quote (("name" . "undelegate") ("signatures" "undelegate" nil (("selector" "A selector which will be used to filter the event results." nil) ("eventType" "A string containing a JavaScript event type, such as \"click\" or \"keydown\"" nil)) (("selector" "A selector which will be used to filter the event results." nil) ("eventType" "A string containing a JavaScript event type, such as \"click\" or \"keydown\"" nil) ("handler" "A function to execute at the time the event is triggered." nil)) (("selector" "A selector which will be used to filter the event results." nil) ("events" "A map of one or more event types and previously bound functions to unbind from them." nil)) (("namespace" "A string containing a namespace to unbind all events from." nil))) ("desc" (text . "   Remove a handler from the event for all elements which match the
...
(puthash "delegate" (quote (("name" . "delegate") ("signatures" "delegate" (("selector" "A selector to filter the elements that trigger the event." nil) ("eventType" "A string containing one or more space-separated JavaScript event types, such as \"click\" or \"keydown,\" or custom event names." nil) ("handler" "A function to execute at the time the event is triggered." nil)) (("selector" "A selector to filter the elements that trigger the event." nil) ("eventType" "A string containing one or more space-separated JavaScript event types, such as \"click\" or \"keydown,\" or custom event names." nil) ("eventData" "A map of data that will be passed to the event handler." nil) ("handler" "A function to execute at the time the event is triggered." nil)) (("selector" "A selector to filter the elements that trigger the event." nil) ("events" "A map of one or more event types and functions to execute for them." nil))) ("desc" (text . "   Attach a handler to one or more events for all elements that match the
...
(puthash "$.error" (quote (("name" . "$.error") ("signatures" "$.error" (("message" "The message to send out." nil))) ("desc" (text . "   Takes a string and throws an exception containing it.
...
(puthash "$.parseJSON" (quote (("name" . "$.parseJSON") ("signatures" "$.parseJSON" (("json" "The JSON string to parse." nil))) ("desc" (text . "   Takes a well-formed JSON string and returns the resulting JavaScript
   object.
...
(puthash "$.proxy" (quote (("name" . "$.proxy") ("signatures" "$.proxy" (("function" "The function whose context will be changed." nil) ("context" "The object to which the context (" nil)) (("context" "The object to which the context of the function should be set." nil) ("name" "The name of the function whose context will be changed (should be a property of the " nil))) ("desc" (text . "   Takes a function and returns a new one that will always have a
   particular context.
...
(puthash "focusout" (quote (("name" . "focusout") ("signatures" "focusout" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil))) ("desc" (text . "   Bind an event handler to the \"focusout\" JavaScript event.
...
(puthash "focusin" (quote (("name" . "focusin") ("signatures" "focusin" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil))) ("desc" (text . "   Bind an event handler to the \"focusin\" JavaScript event.
...
(puthash "has" (quote (("name" . "has") ("signatures" "has" (("selector" "A string containing a selector expression to match elements against." nil)) (("contained" "A DOM element to match elements against." nil))) ("desc" (text . "   Reduce the set of matched elements to those that have a descendant that
...
(puthash "$.contains" (quote (("name" . "$.contains") ("signatures" "$.contains" (("container" "The DOM element that may contain the other element." nil) ("contained" "The DOM node that may be contained by the other element." nil))) ("desc" (text . "   Check to see if a DOM node is within another DOM node.
...
(puthash "delay" (quote (("name" . "delay") ("signatures" "delay" (("duration" "An integer indicating the number of milliseconds to delay execution of the next item in the queue." nil) ("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Set a timer to delay execution of subsequent items in the queue.
...
(puthash "parentsUntil" (quote (("name" . "parentsUntil") ("signatures" "parentsUntil" (("selector" "A string containing a selector expression to indicate where to stop matching ancestor elements." "true"))) ("desc" (text . "   Get the ancestors of each element in the current set of matched
...
(puthash "prevUntil" (quote (("name" . "prevUntil") ("signatures" "prevUntil" (("selector" "A string containing a selector expression to indicate where to stop matching preceding sibling elements." "true"))) ("desc" (text . "   Get all preceding siblings of each element up to but not including the
...
(puthash "nextUntil" (quote (("name" . "nextUntil") ("signatures" "nextUntil" (("selector" "A string containing a selector expression to indicate where to stop matching following sibling elements." "true"))) ("desc" (text . "   Get all following siblings of each element up to but not including the
   element matched by the selector.
...
(puthash "each" (quote (("name" . "each") ("signatures" "each" (("function(index, Element)" "A function to execute for each matched element." nil))) ("desc" (text . "   Iterate over a jQuery object, executing a function for each matched
   element.
...
(puthash "pushStack" (quote (("name" . "pushStack") ("signatures" "pushStack" (("elements" "An array of elements to push onto the stack and make into a new jQuery object." nil)) (("elements" "An array of elements to push onto the stack and make into a new jQuery object." nil) ("name" "The name of a jQuery method that generated the array of elements." nil) ("arguments" "The arguments that were passed in to the jQuery method (for serialization)." nil))) ("desc" (text . "   Add a collection of DOM elements onto the jQuery stack.
...
(puthash "$.globalEval" (quote (("name" . "$.globalEval") ("signatures" "$.globalEval" (("code" "The JavaScript code to execute." nil))) ("desc" (text . "   Execute some JavaScript code globally.
...
(puthash "$.isXMLDoc" (quote (("name" . "$.isXMLDoc") ("signatures" "$.isXMLDoc" (("node" "The DOM node that will be checked to see if it's in an XML document." nil))) ("desc" (text . "   Check to see if a DOM node is within an XML document (or is an XML
   document).
...
(puthash "$.removeData" (quote (("name" . "$.removeData") ("signatures" "$.removeData" (("element" "A DOM element from which to remove data." nil) ("name" "A string naming the piece of data to remove." "true"))) ("desc" (text . "   Remove a previously-stored piece of data.
...
(puthash "$.data" (quote (("name" . "$.data") ("signatures" "$.data" (("element" "The DOM element to associate with the data." nil) ("key" "A string naming the piece of data to set." nil) ("value" "The new data value." nil))) ("desc" (text . "   Store arbitrary data associated with the specified element. Returns the
   value that was set.
...
(puthash "$.data" (quote (("name" . "$.data") ("signatures" "$.data" (("element" "The DOM element to query for the data." nil) ("key" "Name of the data stored." nil)) (("element" "The DOM element to query for the data." nil))) ("desc" (text . "   Returns value at named data store for the element, as set by
...
(puthash "$.dequeue" (quote (("name" . "$.dequeue") ("signatures" "$.dequeue" (("element" "A DOM element from which to remove and execute a queued function." nil) ("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Execute the next function on the queue for the matched element.
...
(puthash "$.queue" (quote (("name" . "$.queue") ("signatures" "$.queue" (("element" "A DOM element to inspect for an attached queue." nil) ("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Show the queue of functions to be executed on the matched element.
...
(puthash "$.queue" (quote (("name" . "$.queue") ("signatures" "$.queue" (("element" "A DOM element where the array of queued functions is attached." nil) ("queueName" "A string containing the name of the queue. Defaults to " nil) ("newQueue" "An array of functions to replace the current queue contents." nil)) (("element" "A DOM element on which to add a queued function." nil) ("queueName" "A string containing the name of the queue. Defaults to " nil) ("callback()" "The new function to add to the queue." nil))) ("desc" (text . "   Manipulate the queue of functions to be executed on the matched
   element.
...
(puthash "clearQueue" (quote (("name" . "clearQueue") ("signatures" "clearQueue" (("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Remove from the queue all items that have not yet been run.
...
(puthash "$.isEmptyObject" (quote (("name" . "$.isEmptyObject") ("signatures" "$.isEmptyObject" (("object" "The object that will be checked to see if it's empty." nil))) ("desc" (text . "   Check to see if an object is empty (contains no properties).
...
(puthash "$.isPlainObject" (quote (("name" . "$.isPlainObject") ("signatures" "$.isPlainObject" (("object" "The object that will be checked to see if it's a plain object." nil))) ("desc" (text . "   Check to see if an object is a plain object (created using \"{}\" or \"new
   Object\").
...
(puthash "keydown" (quote (("name" . "keydown") ("signatures" "keydown" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"keydown\" JavaScript event, or trigger
...
(puthash "index" (quote (("name" . "index") ("signatures" "index" nil (("selector" "A selector representing a jQuery collection in which to look for an element." nil)) (("element" "The DOM element or first element within the jQuery object to look for." nil))) ("desc" (text . "   Search for a given element from among the matched elements.
...
(puthash "removeData" (quote (("name" . "removeData") ("signatures" "removeData" (("name" "A string naming the piece of data to delete." "true"))) ("desc" (text . "   Remove a previously-stored piece of data.
...
(puthash "data" (quote (("name" . "data") ("signatures" "data" (("key" "A string naming the piece of data to set." nil) ("value" "The new data value; it can be any Javascript type including Array or Object." nil)) (("obj" "An object of key-value pairs of data to update." nil))) ("desc" (text . "   Store arbitrary data associated with the matched elements.
...
(puthash "data" (quote (("name" . "data") ("signatures" "data" (("key" "Name of the data stored." nil)) nil) ("desc" (text . "   Returns value at named data store for the first element in the jQuery
...
(puthash "get" (quote (("name" . "get") ("signatures" "get" (("index" "A zero-based integer indicating which element to retrieve." "true"))) ("desc" (text . "   Retrieve the DOM elements matched by the jQuery object.
...
(puthash "$.noConflict" (quote (("name" . "$.noConflict") ("signatures" "$.noConflict" (("removeAll" "A Boolean indicating whether to remove all jQuery variables from the global scope (including jQuery itself)." "true"))) ("desc" (text . "   Relinquish jQueryʼs control of the $ variable.
...
(puthash "scroll" (quote (("name" . "scroll") ("signatures" "scroll" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"scroll\" JavaScript event, or trigger that
   event on an element.
...
(puthash "resize" (quote (("name" . "resize") ("signatures" "resize" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"resize\" JavaScript event, or trigger that
   event on an element.
...
(puthash "dequeue" (quote (("name" . "dequeue") ("signatures" "dequeue" (("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Execute the next function on the queue for the matched elements.
...
(puthash "queue" (quote (("name" . "queue") ("signatures" "queue" (("queueName" "A string containing the name of the queue. Defaults to " "true"))) ("desc" (text . "   Show the queue of functions to be executed on the matched elements.
...
(puthash "queue" (quote (("name" . "queue") ("signatures" "queue" (("queueName" "A string containing the name of the queue. Defaults to " "true") ("newQueue" "An array of functions to replace the current queue contents." nil)) (("queueName" "A string containing the name of the queue. Defaults to " "true") ("callback( next )" "The new function to add to the queue, with a function to call that will dequeue the next item." nil))) ("desc" (text . "   Manipulate the queue of functions to be executed on the matched
   elements.
...
(puthash "keyup" (quote (("name" . "keyup") ("signatures" "keyup" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"keyup\" JavaScript event, or trigger that
   event on an element.
...
(puthash "keypress" (quote (("name" . "keypress") ("signatures" "keypress" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"keypress\" JavaScript event, or trigger
   that event on an element.
...
(puthash "submit" (quote (("name" . "submit") ("signatures" "submit" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"submit\" JavaScript event, or trigger that
   event on an element.
...
(puthash "select" (quote (("name" . "select") ("signatures" "select" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"select\" JavaScript event, or trigger that
   event on an element.
...
(puthash "change" (quote (("name" . "change") ("signatures" "change" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"change\" JavaScript event, or trigger that
   event on an element.
...
(puthash "blur" (quote (("name" . "blur") ("signatures" "blur" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"blur\" JavaScript event, or trigger that
   event on an element.
...
(puthash "focus" (quote (("name" . "focus") ("signatures" "focus" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"focus\" JavaScript event, or trigger that
   event on an element.
...
(puthash "mousemove" (quote (("name" . "mousemove") ("signatures" "mousemove" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"mousemove\" JavaScript event, or trigger
   that event on an element.
...
(puthash "hover" (quote (("name" . "hover") ("signatures" "hover" (("handlerIn(eventObject)" "A function to execute when the mouse pointer enters the element." nil) ("handlerOut(eventObject)" "A function to execute when the mouse pointer leaves the element." nil))) ("desc" (text . "   Bind two handlers to the matched elements, to be executed when the
...
(puthash "hover" (quote (("name" . "hover") ("signatures" "hover" (("handlerInOut(eventObject)" "A function to execute when the mouse pointer enters or leaves the element." nil))) ("desc" (text . "   Bind a single handler to the matched elements, to be executed when the
...
(puthash "mouseleave" (quote (("name" . "mouseleave") ("signatures" "mouseleave" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to be fired when the mouse leaves an element, or
...
(puthash "mouseenter" (quote (("name" . "mouseenter") ("signatures" "mouseenter" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to be fired when the mouse enters an element, or
   trigger that handler on an element.
...
(puthash "mouseout" (quote (("name" . "mouseout") ("signatures" "mouseout" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"mouseout\" JavaScript event, or trigger
   that event on an element.
...
(puthash "mouseover" (quote (("name" . "mouseover") ("signatures" "mouseover" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"mouseover\" JavaScript event, or trigger
   that event on an element.
...
(puthash "dblclick" (quote (("name" . "dblclick") ("signatures" "dblclick" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"dblclick\" JavaScript event, or trigger
   that event on an element.
...
(puthash "click" (quote (("name" . "click") ("signatures" "click" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"click\" JavaScript event, or trigger that
   event on an element.
...
(puthash "mouseup" (quote (("name" . "mouseup") ("signatures" "mouseup" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"mouseup\" JavaScript event, or trigger
   that event on an element.
...
(puthash "mousedown" (quote (("name" . "mousedown") ("signatures" "mousedown" (("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) nil) ("desc" (text . "   Bind an event handler to the \"mousedown\" JavaScript event, or trigger
   that event on an element.
...
(puthash "error" (quote (("name" . "error") ("signatures" "error" (("handler(eventObject)" "A function to execute when the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil))) ("desc" (text . "   Bind an event handler to the \"error\" JavaScript event.
...
(puthash "unload" (quote (("name" . "unload") ("signatures" "unload" (("handler(eventObject)" "A function to execute when the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil))) ("desc" (text . "   Bind an event handler to the \"unload\" JavaScript event.
...
(puthash "load" (quote (("name" . "load") ("signatures" "load" (("handler(eventObject)" "A function to execute when the event is triggered." nil)) (("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil))) ("desc" (text . "   Bind an event handler to the \"load\" JavaScript event.
...
(puthash "ready" (quote (("name" . "ready") ("signatures" "ready" (("handler" "A function to execute after the DOM is ready." nil))) ("desc" (text . "   Specify a function to execute when the DOM is fully loaded.
...
(puthash "die" (quote (("name" . "die") ("signatures" "die" (("eventType" "A string containing a JavaScript event type, such as " nil) ("handler" "The function that is no longer to be executed." "true")) (("eventTypes" "A map of one or more event types, such as " nil))) ("desc" (text . "   Remove an event handler previously attached using .live() from the
   elements.
...
(puthash "live" (quote (("name" . "live") ("signatures" "live" (("eventType" "A string containing a JavaScript event type, such as \"click\" or \"keydown.\" As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names, as well." nil) ("handler" "A function to execute at the time the event is triggered." nil)) (("eventType" "A string containing a JavaScript event type, such as \"click\" or \"keydown.\" As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names, as well." nil) ("eventData" "A map of data that will be passed to the event handler." nil) ("handler" "A function to execute at the time the event is triggered." nil)) (("events" "A map of one or more JavaScript event types and functions to execute for them." nil))) ("desc" (text . "   Attach a handler to the event for all elements which match the current
...
(puthash "triggerHandler" (quote (("name" . "triggerHandler") ("signatures" "triggerHandler" (("eventType" "A string containing a JavaScript event type, such as " nil) ("extraParameters" "An array of additional parameters to pass along to the event handler." nil))) ("desc" (text . "   Execute all handlers attached to an element for an event.
...
(puthash "trigger" (quote (("name" . "trigger") ("signatures" "trigger" (("eventType" "A string containing a JavaScript event type, such as " nil) ("extraParameters" "An array of additional parameters to pass along to the event handler." nil)) (("event" "A " nil))) ("desc" (text . "   Execute all handlers and behaviors attached to the matched elements for
...
(puthash "ajaxComplete" (quote (("name" . "ajaxComplete") ("signatures" "ajaxComplete" (("handler(event, XMLHttpRequest, ajaxOptions)" "The function to be invoked." nil))) ("desc" (text . "   Register a handler to be called when Ajax requests complete. This is an
   Ajax Event.
...
(puthash "one" (quote (("name" . "one") ("signatures" "one" (("eventType" "A string containing one or more JavaScript event types, such as \"click\" or \"submit,\" or custom event names." nil) ("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute at the time the event is triggered." nil))) ("desc" (text . "   Attach a handler to an event for the elements. The handler is executed
...
(puthash "$.ajaxSetup" (quote (("name" . "$.ajaxSetup") ("signatures" "$.ajaxSetup" (("options" "A set of key/value pairs that configure the default Ajax request. All options are optional. " nil))) ("desc" (text . "   Set default values for future Ajax requests.
...
(puthash "ajaxSuccess" (quote (("name" . "ajaxSuccess") ("signatures" "ajaxSuccess" (("handler(event, XMLHttpRequest, ajaxOptions)" "The function to be invoked." nil))) ("desc" (text . "   Attach a function to be executed whenever an Ajax request completes
...
(puthash "ajaxStop" (quote (("name" . "ajaxStop") ("signatures" "ajaxStop" (("handler()" "The function to be invoked." nil))) ("desc" (text . "   Register a handler to be called when all Ajax requests have completed.
...
(puthash "ajaxStart" (quote (("name" . "ajaxStart") ("signatures" "ajaxStart" (("handler()" "The function to be invoked." nil))) ("desc" (text . "   Register a handler to be called when the first Ajax request begins.
   This is an Ajax Event.
...
(puthash "ajaxSend" (quote (("name" . "ajaxSend") ("signatures" "ajaxSend" (("handler(event, jqXHR, ajaxOptions)" "The function to be invoked." nil))) ("desc" (text . "   Attach a function to be executed before an Ajax request is sent. This
   is an Ajax Event.
...
(puthash "ajaxError" (quote (("name" . "ajaxError") ("signatures" "ajaxError" (("handler(event, jqXHR, ajaxSettings, thrownError)" "The function to be invoked." nil))) ("desc" (text . "   Register a handler to be called when Ajax requests complete with an
...
(puthash "unbind" (quote (("name" . "unbind") ("signatures" "unbind" (("eventType" "A string containing a JavaScript event type, such as " "true") ("handler(eventObject)" "The function that is to be no longer executed." "true")) (("eventType" "A string containing a JavaScript event type, such as " nil) ("false" "Unbinds the corresponding 'return false' function that was bound using " nil)) (("event" "A JavaScript event object as passed to an event handler." nil))) ("desc" (text . "   Remove a previously-attached event handler from the elements.
...
(puthash "bind" (quote (("name" . "bind") ("signatures" "bind" (("eventType" "A string containing one or more JavaScript event types, such as \"click\" or \"submit,\" or custom event names." nil) ("eventData" "A map of data that will be passed to the event handler." "true") ("handler(eventObject)" "A function to execute each time the event is triggered." nil)) (("eventType" "A string containing one or more JavaScript event types, such as \"click\" or \"submit,\" or custom event names." nil) ("eventData" "A map of data that will be passed to the event handler." "true") ("false" "Setting the third argument to false will attach a function that prevents the default action from occurring and stops the event from bubbling." nil)) (("events" "A map of one or more JavaScript event types and functions to execute for them." nil))) ("desc" (text . "   Attach a handler to an event for the elements.
...
(puthash "slice" (quote (("name" . "slice") ("signatures" "slice" (("start" "An integer indicating the 0-based position at which the elements begin to be selected. If negative, it indicates an offset from the end of the set." nil) ("end" "An integer indicating the 0-based position at which the elements stop being selected. If negative, it indicates an offset from the end of the set. If omitted, the range continues until the end of the set." "true"))) ("desc" (text . "   Reduce the set of matched elements to a subset specified by a range of
   indices.
...
(puthash "jQuery" (quote (("name" . "jQuery") ("signatures" "jQuery" (("selector" "A string containing a selector expression" nil) ("context" "A DOM Element, Document, or jQuery to use as context" "true")) (("element" "A DOM element to wrap in a jQuery object." nil)) (("elementArray" "An array containing a set of DOM elements to wrap in a jQuery object." nil)) (("jQuery object" "An existing jQuery object to clone." nil)) nil) ("desc" (text . "   Accepts a string containing a CSS selector which is then used to match
   a set of elements.
...
(puthash "jQuery" (quote (("name" . "jQuery") ("signatures" "jQuery" (("html" "A string of HTML to create on the fly. Note that this parses HTML, " nil) ("ownerDocument" "A document in which the new elements will be created" "true")) (("html" "A string defining a single, standalone, HTML element (e.g. <div/> or <div></div>)." nil) ("props" "An map of attributes, events, and methods to call on the newly-created element." nil))) ("desc" (text . "   Creates DOM elements on the fly from the provided string of raw HTML.
...
(puthash "jQuery" (quote (("name" . "jQuery") ("signatures" "jQuery" (("callback" "The function to execute when the DOM is ready." nil))) ("desc" (text . "   Binds a function to be executed when the DOM has finished loading.
...
(puthash "stop" (quote (("name" . "stop") ("signatures" "stop" (("clearQueue" "A Boolean indicating whether to remove queued animation as well. Defaults to " "true") ("jumpToEnd" "A Boolean indicating whether to complete the current animation immediately. Defaults to " "true"))) ("desc" (text . "   Stop the currently-running animation on the matched elements.
...
(puthash "siblings" (quote (("name" . "siblings") ("signatures" "siblings" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the siblings of each element in the set of matched elements,
...
(puthash "animate" (quote (("name" . "animate") ("signatures" "animate" (("properties" "A map of CSS properties that the animation will move toward." nil) ("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("complete" "A function to call once the animation is complete." "true")) (("properties" "A map of CSS properties that the animation will move toward." nil) ("options" "A map of additional options to pass to the method. Supported keys:
	      " nil))) ("desc" (text . "   Perform a custom animation of a set of CSS properties.
...
(puthash "prevAll" (quote (("name" . "prevAll") ("signatures" "prevAll" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get all preceding siblings of each element in the set of matched
...
(puthash "prev" (quote (("name" . "prev") ("signatures" "prev" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the immediately preceding sibling of each element in the set of
...
(puthash "fadeTo" (quote (("name" . "fadeTo") ("signatures" "fadeTo" (("duration" "A string or number determining how long the animation will run." nil) ("opacity" "A number between 0 and 1 denoting the target opacity." nil) ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." nil) ("opacity" "A number between 0 and 1 denoting the target opacity." nil) ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Adjust the opacity of the matched elements.
...
(puthash "fadeOut" (quote (("name" . "fadeOut") ("signatures" "fadeOut" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Hide the matched elements by fading them to transparent.
...
(puthash "parents" (quote (("name" . "parents") ("signatures" "parents" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the ancestors of each element in the current set of matched
   elements, optionally filtered by a selector.
...
(puthash "fadeIn" (quote (("name" . "fadeIn") ("signatures" "fadeIn" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Display the matched elements by fading them to opaque.
...
(puthash "parent" (quote (("name" . "parent") ("signatures" "parent" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the parent of each element in the current set of matched elements,
   optionally filtered by a selector.
...
(puthash "slideToggle" (quote (("name" . "slideToggle") ("signatures" "slideToggle" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Display or hide the matched elements with a sliding motion.
...
(puthash "$.post" (quote (("name" . "$.post") ("signatures" "$.post" (("url" "A string containing the URL to which the request is sent." nil) ("data" "A map or string that is sent to the server with the request." "true") ("success(data, textStatus, jqXHR)" "A callback function that is executed if the request succeeds." "true") ("dataType" "The type of data expected from the server. Default: Intelligent Guess (xml, json, script, or html)." "true"))) ("desc" (text . "   Load data from the server using a HTTP POST request.
...
(puthash "slideUp" (quote (("name" . "slideUp") ("signatures" "slideUp" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Hide the matched elements with a sliding motion.
...
(puthash "nextAll" (quote (("name" . "nextAll") ("signatures" "nextAll" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get all following siblings of each element in the set of matched
   elements, optionally filtered by a selector.
...
(puthash "next" (quote (("name" . "next") ("signatures" "next" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the immediately following sibling of each element in the set of
...
(puthash "slideDown" (quote (("name" . "slideDown") ("signatures" "slideDown" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Display the matched elements with a sliding motion.
...
(puthash "find" (quote (("name" . "find") ("signatures" "find" (("selector" "A string containing a selector expression to match elements against." nil)) (("jQuery object" "A jQuery object to match elements against." nil)) (("element" "An element to match elements against." nil))) ("desc" (text . "   Get the descendants of each element in the current set of matched
...
(puthash "$.getScript" (quote (("name" . "$.getScript") ("signatures" "$.getScript" (("url" "A string containing the URL to which the request is sent." nil) ("success(data, textStatus)" "A callback function that is executed if the request succeeds." "true"))) ("desc" (text . "   Load a JavaScript file from the server using a GET HTTP request, then
   execute it.
...
(puthash "closest" (quote (("name" . "closest") ("signatures" "closest" (("selector" "A string containing a selector expression to match elements against." nil)) (("selector" "A string containing a selector expression to match elements against." nil) ("context" "A DOM element within which a matching element may be found. If no context is passed in then the context of the jQuery set will be used instead." "true")) (("jQuery object" "A jQuery object to match elements against." nil)) (("element" "An element to match elements against." nil))) ("desc" (text . "   Get the first ancestor element that matches the selector, beginning at
...
(puthash "closest" (quote (("name" . "closest") ("signatures" "closest" (("selectors" "An array or string containing a selector expression to match elements against (can also be a jQuery object)." nil) ("context" "A DOM element within which a matching element may be found. If no context is passed in then the context of the jQuery set will be used instead." "true"))) ("desc" (text . "   Gets an array of all the elements and selectors matched against the
...
(puthash "$.getJSON" (quote (("name" . "$.getJSON") ("signatures" "$.getJSON" (("url" "A string containing the URL to which the request is sent." nil) ("data" "A map or string that is sent to the server with the request." "true") ("success(data, textStatus, jqXHR)" "A callback function that is executed if the request succeeds." "true"))) ("desc" (text . "   Load JSON-encoded data from the server using a GET HTTP request.
...
(puthash "$.get" (quote (("name" . "$.get") ("signatures" "$.get" (("url" "A string containing the URL to which the request is sent." nil) ("data" "A map or string that is sent to the server with the request." "true") ("success(data, textStatus, jqXHR)" "A callback function that is executed if the request succeeds." "true") ("dataType" "The type of data expected from the server. Default: Intelligent Guess (xml, json, script, or html)." "true"))) ("desc" (text . "   Load data from the server using a HTTP GET request.
...
(puthash "load" (quote (("name" . "load") ("signatures" "load" (("url" "A string containing the URL to which the request is sent." nil) ("data" "A map or string that is sent to the server with the request." "true ") ("complete(responseText, textStatus, XMLHttpRequest)" "A callback function that is executed when the request completes." "true"))) ("desc" (text . "   Load data from the server and place the returned HTML into the matched
   element.
...
(puthash "$.ajax" (quote (("name" . "$.ajax") ("signatures" "$.ajax" (("url" "A string containing the URL to which the request is sent." nil) ("settings" "A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with " "true")) (("settings" "A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with " nil))) ("desc" (text . "   Perform an asynchronous HTTP (Ajax) request.
...
(puthash "children" (quote (("name" . "children") ("signatures" "children" (("selector" "A string containing a selector expression to match elements against." "true"))) ("desc" (text . "   Get the children of each element in the set of matched elements,
   optionally filtered by a selector.
...
(puthash "add" (quote (("name" . "add") ("signatures" "add" (("selector" "A string representing a selector expression to find additional elements to add to the set of matched elements." nil)) (("elements" "One or more elements to add to the set of matched elements." nil)) (("html" "An HTML fragment to add to the set of matched elements." nil)) (("selector" "A string representing a selector expression to find additional elements to add to the set of matched elements." nil) ("context" "The point in the document at which the selector should begin matching; similar to the context argument of the " nil))) ("desc" (text . "   Add elements to the set of matched elements.
...
(puthash "not" (quote (("name" . "not") ("signatures" "not" (("selector" "A string containing a selector expression to match elements against." nil)) (("elements" "One or more DOM elements to remove from the matched set." nil)) (("function(index)" "A function used as a test for each element in the set. " nil))) ("desc" (text . "   Remove elements from the set of matched elements.
...
(puthash "outerWidth" (quote (("name" . "outerWidth") ("signatures" "outerWidth" (("includeMargin" "A Boolean indicating whether to include the element's margin in the calculation." "true"))) ("desc" (text . "   Get the current computed width for the first element in the set of
...
(puthash "outerHeight" (quote (("name" . "outerHeight") ("signatures" "outerHeight" (("includeMargin" "A Boolean indicating whether to include the element's margin in the calculation." "true"))) ("desc" (text . "   Get the current computed height for the first element in the set of
...
(puthash "toggle" (quote (("name" . "toggle") ("signatures" "toggle" (("duration" "A string or number determining how long the animation will run." "true") ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true")) (("showOrHide" "A Boolean indicating whether to show or hide the elements." nil))) ("desc" (text . "   Display or hide the matched elements.
...
(puthash "$.param" (quote (("name" . "$.param") ("signatures" "$.param" (("obj" "An array or object to serialize." nil)) (("obj" "An array or object to serialize." nil) ("traditional" "A Boolean indicating whether to perform a traditional \"shallow\" serialization." nil))) ("desc" (text . "   Create a serialized representation of an array or object, suitable for
...
(puthash "hide" (quote (("name" . "hide") ("signatures" "hide" nil (("duration" "A string or number determining how long the animation will run." nil) ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Hide the matched elements.
...
(puthash "width" (quote (("name" . "width") ("signatures" "width" (("value" "An integer representing the number of pixels, or an integer along with an optional unit of measure appended (as a string)." nil)) (("function(index, width)" "A function returning the width to set. Receives the index position of the element in the set and the old width as arguments." nil))) ("desc" (text . "   Set the CSS width of each element in the set of matched elements.
...
(puthash "height" (quote (("name" . "height") ("signatures" "height" (("value" "An integer representing the number of pixels, or an integer with an optional unit of measure appended (as a string)." nil)) (("function(index, height)" "A function returning the height to set. Receives the index position of the element in the set and the old height as arguments." nil))) ("desc" (text . "   Set the CSS height of every matched element.
...
(puthash "show" (quote (("name" . "show") ("signatures" "show" nil (("duration" "A string or number determining how long the animation will run." nil) ("callback" "A function to call once the animation is complete." "true")) (("duration" "A string or number determining how long the animation will run." "true") ("easing" "A string indicating which easing function to use for the transition." "true") ("callback" "A function to call once the animation is complete." "true"))) ("desc" (text . "   Display the matched elements.
...
(puthash "scrollLeft" (quote (("name" . "scrollLeft") ("signatures" "scrollLeft" (("value" "An integer indicating the new position to set the scroll bar to." nil))) ("desc" (text . "   Set the current horizontal position of the scroll bar for each of the
...
(puthash "$.trim" (quote (("name" . "$.trim") ("signatures" "$.trim" (("str" "The string to trim." nil))) ("desc" (text . "   Remove the whitespace from the beginning and end of a string.
...
(puthash "$.isFunction" (quote (("name" . "$.isFunction") ("signatures" "$.isFunction" (("obj" "Object to test whether or not it is a function." nil))) ("desc" (text . "   Determine if the argument passed is a Javascript function object.
...
(puthash "$.isArray" (quote (("name" . "$.isArray") ("signatures" "$.isArray" (("obj" "Object to test whether or not it is an array." nil))) ("desc" (text . "   Determine whether the argument is an array.
...
(puthash "$.unique" (quote (("name" . "$.unique") ("signatures" "$.unique" (("array" "The Array of DOM elements." nil))) ("desc" (text . "   Sorts an array of DOM elements, in place, with the duplicates removed.
...
(puthash "$.merge" (quote (("name" . "$.merge") ("signatures" "$.merge" (("first" "The first array to merge, the elements of second added." nil) ("second" "The second array to merge into the first, unaltered." nil))) ("desc" (text . "   Merge the contents of two arrays together into the first array.
...
(puthash "$.inArray" (quote (("name" . "$.inArray") ("signatures" "$.inArray" (("value" "The value to search for." nil) ("array" "An array through which to search." nil))) ("desc" (text . "   Search for a specified value within an array and return its index (or
   -1 if not found).
...
(puthash "$.map" (quote (("name" . "$.map") ("signatures" "$.map" (("array" "The Array to translate." nil) ("callback(elementOfArray, indexInArray)" "The function to process each item against.  The first argument to the function is the array item, the second argument is the index in array The function can return any value. Within the function, " nil)) (("arrayOrObject" "The Array or Object to translate." nil) ("callback( value, indexOrKey )" "The function to process each item against.  The first argument to the function is the value; the second argument is the index or key of the array or object property. The function can return any value to add to the array. A returned array will be flattened into the resulting array. Within the function, " nil))) ("desc" (text . "   Translate all items in an array or object to new array of items.
...
(puthash "$.makeArray" (quote (("name" . "$.makeArray") ("signatures" "$.makeArray" (("obj" "Any object to turn into a native Array." nil))) ("desc" (text . "   Convert an array-like object into a true JavaScript array.
...
(puthash "$.grep" (quote (("name" . "$.grep") ("signatures" "$.grep" (("array" "The array to search through." nil) ("function(elementOfArray, indexInArray)" "The function to process each item against.  The first argument to the function is the item, and the second argument is the index.  The function should return a Boolean value.  " nil) ("invert" "If \"invert\" is false, or not provided, then the function returns an array consisting of all elements for which \"callback\" returns true.  If \"invert\" is true, then the function returns an array consisting of all elements for which \"callback\" returns false." "true"))) ("desc" (text . "   Finds the elements of an array which satisfy a filter function. The
...
(puthash "$.extend" (quote (("name" . "$.extend") ("signatures" "$.extend" (("target" " An object that will receive the new properties if additional objects are passed in or that will extend the jQuery namespace if it is the sole argument." nil) ("object1" "An object containing additional properties to merge in." "true") ("objectN" "Additional objects containing properties to merge in." "true")) (("deep" "If true, the merge becomes recursive (aka. deep copy)." "true") ("target" "The object to extend. It will receive the new properties." nil) ("object1" "An object containing additional properties to merge in." nil) ("objectN" "Additional objects containing properties to merge in." "true"))) ("desc" (text . "   Merge the contents of two or more objects together into the first
   object.
...
(puthash "$.each" (quote (("name" . "$.each") ("signatures" "$.each" (("collection" "The object or array to iterate over." nil) ("callback(indexInArray, valueOfElement)" "The function that will be executed on every object." nil))) ("desc" (text . "   A generic iterator function, which can be used to seamlessly iterate
...
(puthash "scrollTop" (quote (("name" . "scrollTop") ("signatures" "scrollTop" (("value" "An integer indicating the new position to set the scroll bar to." nil))) ("desc" (text . "   Set the current vertical position of the scroll bar for each of the set
   of matched elements.
...
(puthash "offset" (quote (("name" . "offset") ("signatures" "offset" (("coordinates" "An object containing the properties " nil)) (("function(index, coords)" "A function to return the coordinates to set. Receives the index of the element in the collection as the first argument and the current coordinates as the second argument. The function should return an object with the new " nil))) ("desc" (text . "   Set the current coordinates of every element in the set of matched
   elements, relative to the document.
...
(puthash "css" (quote (("name" . "css") ("signatures" "css" (("propertyName" "A CSS property." nil))) ("desc" (text . "   Get the value of a style property for the first element in the set of
   matched elements.
...
(puthash "css" (quote (("name" . "css") ("signatures" "css" (("propertyName" "A CSS property name." nil) ("value" "A value to set for the property." nil)) (("propertyName" "A CSS property name." nil) ("function(index, value)" "A function returning the value to set. Receives the index position of the element in the set and the old value as arguments." nil)) (("map" "A map of property-value pairs to set." nil))) ("desc" (text . "   Set one or more CSS properties for the set of matched elements.
...
(puthash "detach" (quote (("name" . "detach") ("signatures" "detach" (("selector" "A selector expression that filters the set of matched elements to be removed." "true"))) ("desc" (text . "   Remove the set of matched elements from the DOM.
...
(puthash "clone" (quote (("name" . "clone") ("signatures" "clone" (("withDataAndEvents" "A Boolean indicating whether event handlers should be copied along with the elements. As of jQuery 1.4, element data will be copied as well." "true")) (("withDataAndEvents" "A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is " "true") ("deepWithDataAndEvents" "A Boolean indicating whether event handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to " "true"))) ("desc" (text . "   Create a deep copy of the set of matched elements.
...
(puthash "remove" (quote (("name" . "remove") ("signatures" "remove" (("selector" "A selector expression that filters the set of matched elements to be removed." "true"))) ("desc" (text . "   Remove the set of matched elements from the DOM.
...
(puthash "replaceAll" (quote (("name" . "replaceAll") ("signatures" "replaceAll" (("target" "A selector expression indicating which element(s) to replace." nil))) ("desc" (text . "   Replace each target element with the set of matched elements.
...
(puthash "replaceWith" (quote (("name" . "replaceWith") ("signatures" "replaceWith" (("newContent" "The content to insert. May be an HTML string, DOM element, or jQuery object." nil)) (("function" "A function that returns content with which to replace the set of matched elements." nil))) ("desc" (text . "   Replace each element in the set of matched elements with the provided
   new content.
...
(puthash "wrapInner" (quote (("name" . "wrapInner") ("signatures" "wrapInner" (("wrappingElement" "An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the content of the matched elements." nil)) (("wrappingFunction" "A callback function which generates a structure to wrap around the content of the matched elements." nil))) ("desc" (text . "   Wrap an HTML structure around the content of each element in the set of
   matched elements.
...
(puthash "wrapAll" (quote (("name" . "wrapAll") ("signatures" "wrapAll" (("wrappingElement" "An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the matched elements." nil))) ("desc" (text . "   Wrap an HTML structure around all elements in the set of matched
   elements.
...
(puthash "wrap" (quote (("name" . "wrap") ("signatures" "wrap" (("wrappingElement" "An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the matched elements." nil)) (("function(index)" "A callback function returning the HTML content or jQuery object to wrap around the matched elements." nil))) ("desc" (text . "   Wrap an HTML structure around each element in the set of matched
   elements.
...
(puthash "insertBefore" (quote (("name" . "insertBefore") ("signatures" "insertBefore" (("target" "A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted before the element(s) specified by this parameter." nil))) ("desc" (text . "   Insert every element in the set of matched elements before the target.
...
(puthash "before" (quote (("name" . "before") ("signatures" "before" (("content" "HTML string, DOM element, or jQuery object to insert before each element in the set of matched elements." nil) ("content" "One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert before each element in the set of matched elements." "true")) (("function" "A function that returns an HTML string to insert before each element in the set of matched elements." nil))) ("desc" (text . "   Insert content, specified by the parameter, before each element in the
   set of matched elements.
...
(puthash "insertAfter" (quote (("name" . "insertAfter") ("signatures" "insertAfter" (("target" "A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted after the element(s) specified by this parameter." nil))) ("desc" (text . "   Insert every element in the set of matched elements after the target.
...
(puthash "after" (quote (("name" . "after") ("signatures" "after" (("content" "HTML string, DOM element, or jQuery object to insert after each element in the set of matched elements." nil) ("content" "One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert after each element in the set of matched elements." "true")) (("function(index)" "A function that returns an HTML string to insert after each element in the set of matched elements." nil))) ("desc" (text . "   Insert content, specified by the parameter, after each element in the
   set of matched elements.
...
(puthash "prependTo" (quote (("name" . "prependTo") ("signatures" "prependTo" (("target" "A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the beginning of the element(s) specified by this parameter." nil))) ("desc" (text . "   Insert every element in the set of matched elements to the beginning of
   the target.
...
(puthash "prepend" (quote (("name" . "prepend") ("signatures" "prepend" (("content" "DOM element, array of elements, HTML string, or jQuery object to insert at the beginning of each element in the set of matched elements." nil) ("content" "One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the beginning of each element in the set of matched elements." "true")) (("function(index, html)" "A function that returns an HTML string to insert at the beginning of each element in the set of matched elements. Receives the index position of the element in the set and the old HTML value of the element as arguments." nil))) ("desc" (text . "   Insert content, specified by the parameter, to the beginning of each
   element in the set of matched elements.
...
(puthash "appendTo" (quote (("name" . "appendTo") ("signatures" "appendTo" (("target" "A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the end of the element(s) specified by this parameter." nil))) ("desc" (text . "   Insert every element in the set of matched elements to the end of the
   target.
...
(puthash "append" (quote (("name" . "append") ("signatures" "append" (("content" "DOM element, HTML string, or jQuery object to insert at the end of each element in the set of matched elements." nil) ("content" "One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the end of each element in the set of matched elements." "true")) (("function(index, html)" "A function that returns an HTML string to insert at the end of each element in the set of matched elements. Receives the index position of the element in the set and the old HTML value of the element as arguments." nil))) ("desc" (text . "   Insert content, specified by the parameter, to the end of each element
...
(puthash "val" (quote (("name" . "val") ("signatures" "val" (("value" "A string of text or an array of strings corresponding to the value of each matched element to set as selected/checked." nil)) (("function(index, value)" "A function returning the value to set." nil))) ("desc" (text . "   Set the value of each element in the set of matched elements.
...
(puthash "text" (quote (("name" . "text") ("signatures" "text" (("textString" "A string of text to set as the content of each matched element." nil)) (("function(index, text)" "A function returning the text content to set. Receives the index position of the element in the set and the old text value as arguments." nil))) ("desc" (text . "   Set the content of each element in the set of matched elements to the
   specified text.
...
(puthash "html" (quote (("name" . "html") ("signatures" "html" (("htmlString" "A string of HTML to set as the content of each matched element." nil)) (("function(index, oldhtml)" "A function returning the HTML content to set. Receives the index position of the element in the set and the old HTML value as arguments. jQuery empties the element before calling the function; use the oldhtml argument to reference the previous content." nil))) ("desc" (text . "   Set the HTML contents of each element in the set of matched elements.
...
(puthash "map" (quote (("name" . "map") ("signatures" "map" (("callback(index, domElement)" "A function object that will be invoked for each element in the current set." nil))) ("desc" (text . "   Pass each element in the current matched set through a function,
...
(puthash "is" (quote (("name" . "is") ("signatures" "is" (("selector" "A string containing a selector expression to match elements against." nil)) (("function(index)" "A function used as a test for the set of elements. It accepts one argument, " nil)) (("jQuery object" "An existing jQuery object to match the current set of elements against." nil)) (("element" "An element to match the current set of elements against." nil))) ("desc" (text . "   Check the current matched set of elements against a selector, element,
...
(puthash "eq" (quote (("name" . "eq") ("signatures" "eq" (("index" "An integer indicating the 0-based position of the element. " nil)) (("-index" "An integer indicating the position of the element, counting backwards  from the last element in the set. " nil))) ("desc" (text . "   Reduce the set of matched elements to the one at the specified index.
...
(puthash "filter" (quote (("name" . "filter") ("signatures" "filter" (("selector" "A string containing a selector expression to match the current set of elements against." nil)) (("function(index)" "A function used as a test for each element in the set. " nil)) (("element" "An element to match the current set of elements against." nil)) (("jQuery object" "An existing jQuery object to match the current set of elements against." nil))) ("desc" (text . "   Reduce the set of matched elements to those that match the selector or
...
(puthash "toggleClass" (quote (("name" . "toggleClass") ("signatures" "toggleClass" (("className" "One or more class names (separated by spaces) to be toggled for each element in the matched set." nil)) (("className" "One or more class names (separated by spaces) to be toggled for each element in the matched set." nil) ("switch" "A boolean value to determine whether the class should be added or removed." nil)) (("function(index, class)" "A function that returns class names to be toggled in the class attribute of each element in the matched set. Receives the index position of the element in the set and the old class value as arguments." nil) ("switch" "A boolean value to determine whether the class should be added or removed." "true"))) ("desc" (text . "   Add or remove one or more classes from each element in the set of
...
(puthash "removeClass" (quote (("name" . "removeClass") ("signatures" "removeClass" (("className" "One or more space-separated classes to be removed from the class attribute of each matched element." "true")) (("function(index, class)" "A function returning one or more space-separated class names to be removed. Receives the index position of the element in the set and the old class value as arguments." nil))) ("desc" (text . "   Remove a single class, multiple classes, or all classes from each
   element in the set of matched elements.
...
(puthash "hasClass" (quote (("name" . "hasClass") ("signatures" "hasClass" (("className" "The class name to search for." nil))) ("desc" (text . "   Determine whether any of the matched elements are assigned the given
   class.
...
(puthash "removeAttr" (quote (("name" . "removeAttr") ("signatures" "removeAttr" (("attributeName" "An attribute to remove." nil))) ("desc" (text . "   Remove an attribute from each element in the set of matched elements.
...
(puthash "attr" (quote (("name" . "attr") ("signatures" "attr" (("attributeName" "The name of the attribute to get." nil))) ("desc" (text . "   Get the value of an attribute for the first element in the set of
   matched elements.
...
(puthash "attr" (quote (("name" . "attr") ("signatures" "attr" (("attributeName" "The name of the attribute to set." nil) ("value" "A value to set for the attribute." nil)) (("map" "A map of attribute-value pairs to set." nil)) (("attributeName" "The name of the attribute to set." nil) ("function(index, attr)" "A function returning the value to set. " nil))) ("desc" (text . "   Set one or more attributes for the set of matched elements.
...
(puthash "addClass" (quote (("name" . "addClass") ("signatures" "addClass" (("className" "One or more class names to be added to the class attribute of each matched element." nil)) (("function(index, currentClass)" "A function returning one or more space-separated class names to be added. Receives the index position of the element in the set and the old class value as arguments." nil))) ("desc" (text . "   Adds the specified class(es) to each of the set of matched elements.
...
(puthash "$.tmpl" (quote (("name" . "$.tmpl") ("signatures" "$.tmpl" (("template" "The HTML markup or text to use as a template." nil) ("data" "The data to render. This can be any JavaScript type, including Array or Object." "true") ("options" "An optional map of user-defined key-value pairs. Extends the " "true"))) ("desc" (text . "   Render the specified HTML content as a template, using the specified
   data.
...
(puthash "template" (quote (("name" . "template") ("signatures" "template" (("name" "A string naming the compiled template." "true"))) ("desc" (text . "   Compile the contents of the matched element as a reusable compiled
   template.
...
(puthash "unlink" (quote (("name" . "unlink") ("signatures" "unlink" (("target" "An object to unlink." nil))) ("desc" (text . "   Remove a previously created link.
...
(puthash "link" (quote (("name" . "link") ("signatures" "link" (("target" "An object to link changes to." nil) ("settings" "A map describing the fields to link." "true"))) ("desc" (text . "   Link changes to the matched elements to an object.
...
(puthash "$.tmplItem" (quote (("name" . "$.tmplItem") ("signatures" "$.tmplItem" (("element" "An HTML element (or jQuery object that wraps an element)" nil))) ("desc" (text . "   Return the tmplItem data structure for the rendered template that the
...
(puthash "$.template" (quote (("name" . "$.template") ("signatures" "$.template" (("name" "A string naming the compiled template." nil) ("template" "The HTML markup and/or text to be used as template. Can be a string, or an HTML element (or jQuery object wrapping an element) whose content is to be used as template" nil))) ("desc" (text . "   Create a reusable named template (compiled from markup).
...
(puthash "$.template" (quote (("name" . "$.template") ("signatures" "$.template" (("template" "The template markup to be compiled, or a string corresponding to a named template." nil))) ("desc" (text . "   Returns a compiled-template function.
...
(puthash ".tmpl" (quote (("name" . ".tmpl") ("signatures" ".tmpl" (("data" "The data to render. This can be any JavaScript type, including Array or Object." "true") ("options" "An optional map of user-defined key-value pairs. Extends the " "true"))) ("desc" (text . "   Take the first element in the matched set and render its content as a
